...
class DoaNaikKendaraan : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        next.setOnClickListener {
            ...
            val go = Intent(this@DoaNaikKendaraan, DoaMasukRumah::class.java)
            //menjalankan intent
            startActivity(go)
        }
        back.setOnClickListener {
            //berpindah activity Intent(activity-saat-ini, activity-tujuan)
            val go = Intent(this@DoaNaikKendaraan, DoaKeluarRumah::class.java)
            //menjalankan intent
            startActivity(go)
        }
        home3.setOnClickListener {
            //berpindah activity Intent(activity-saat-ini, activity-tujuan)
            val go = Intent(this@DoaNaikKendaraan, MainActivity2::class.java)
            //menjalankan intent
            startActivity(go)
        }
        ...
        imageList.add(SlideModel(R.drawable.naik_arab, ScaleTypes.FIT))
        imageList.add(SlideModel(R.drawable.naik_latin, ScaleTypes.FIT))
        imageList.add(SlideModel(R.drawable.naik_idn, ScaleTypes.FIT))
